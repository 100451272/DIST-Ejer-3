...
enum clnt_stat 
set_value_rpc_1(tupla tupla, int *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
get_value_rpc_1(int key, tupla *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
modify_value_rpc_1(tupla tupla, int *clnt_res,  CLIENT *clnt)
{
...
enum clnt_stat 
copy_key_rpc_1(double_key keys, int *clnt_res,  CLIENT *clnt)
{
	return (clnt_call(clnt, copy_key_rpc,
