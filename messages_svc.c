...
int
_set_value_1 (tupla  *argp, void *result, struct svc_req *rqstp)
{
...
int
_modify_value_1 (tupla  *argp, void *result, struct svc_req *rqstp)
{
...
int
_copy_key_1 (double_key  *argp, void *result, struct svc_req *rqstp)
{
...
messages_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		...
		int exist_1_arg;
		double_key copy_key_1_arg;
	} argument;
	union {
		int init_1_res;
		int set_value_1_res;
		tupla get_value_1_res;
